...
const proseStyleA = "prose-a:after:content-['_↗'] prose-a:text-avocado-400 hover:prose-a:text-avocado-600 dark:prose-a:text-avocado-600 dark:hover:prose-a:text-avocado-400 prose-a:underline prose-a:underline-offset-4";
