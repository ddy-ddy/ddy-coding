<script lang="ts">
  ...
  import { Users, MapPinned, Github, Twitter } from "lucide-svelte";
    ...
    <div class="rounded-xl border bg-card text-card-foreground shadow lg:col-span-2 p-8">
      <div class="flex flex-col justify-center space-y-4">
        ...
        <div class="flex space-x-2">
          <a class="flex space-x-1 items-end" href="https://github.com/ddy-ddy?tab=followers">
            <Users class="h-4 w-4"></Users>
            <div class="-mb-[1px] text-xs font-medium text-foreground/80 hover:text-avocado-400 dark:hover:text-avocado-600">156 followers</div>
          </a>
        ...
        <Separator />
        <div class="font-bold text-sm text-foreground/80">Social</div>
        <div class="flex space-x-2">
          <Avatar.Root class="h-8 w-8 bg-avocado-200 dark:bg-avocado-800 self-center">
            <Icons.logo class="ml-[1px]" />
          </Avatar.Root>
          <Avatar.Root class="h-8 w-8 bg-avocado-200 dark:bg-avocado-800 self-center">
            <Icons.logo class="ml-[1px]" />
